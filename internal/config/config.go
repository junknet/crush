...
type SelectedModel struct {
	...
	ReasoningEffort string `json:"reasoning_effort,omitempty" jsonschema:"description=Reasoning effort level for models that support configurable reasoning,enum=minimal,enum=low,enum=medium,enum=high,enum=xhigh"`
...
type ProviderConfig struct {
	...
	Type catwalk.Type `json:"type,omitempty" jsonschema:"description=Provider type that determines the API format,enum=openai,enum=openai-compat,enum=anthropic,enum=google,enum=gemini,enum=azure,enum=vertexai,enum=antigravity,enum=anthropic-oauth,default=openai"`
