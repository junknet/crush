...
### Reliability Issues
- **Anthropic Empty Text Blocks**: claude-sonnet-4-6 was observed emitting empty text blocks before tool calls. When these are echoed back in context, they trigger 400: User message has no text content errors from upstream providers (WaitAI).
